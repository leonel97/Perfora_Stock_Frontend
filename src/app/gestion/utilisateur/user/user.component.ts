 ...
 //magasin list
  ...
  makeForm(user: User): void {
    ...
    this.validateForm = this.fb.group({
      ...
      activeUtilisateur: [user != null ? user.activeUtilisateur: null],
      dateLastConnex: [user != null ? user.dateLastConnex: null],
      askMdp1erLance: [user != null ? user.askMdp1erLance: null],
      accesChildService: [user != null ? user.accesChildService: null],
